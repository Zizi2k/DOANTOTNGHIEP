/**
 * Controller báo cáo lớp (Class Report)
 * Nhắc bài chưa làm, gửi thông báo/Zalo và xuất Excel bảng điểm.
 */
...
/** GET /classes/:id/pending-work — Học sinh cần nhắc hoàn thành bài. Quyền manage lớp. */
...
/**
 * POST /classes/:id/send-reminders — Gửi thông báo app + Zalo cho học sinh chưa làm bài.
 * Body: student_ids[] (tùy chọn — mặc định tất cả trong danh sách nhắc).
 */
...
/** GET /classes/:id/export-grades — Tải file Excel bảng điểm lớp. */
