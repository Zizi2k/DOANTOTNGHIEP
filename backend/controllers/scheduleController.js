/**
 * Controller lịch học (Schedule)
 * Lịch khung giờ giáo viên dạy và đăng ký slot của học sinh.
 */
...
/** GET /classes/:classId/schedule — Lịch tháng. Query: month (YYYY-MM). */
...
/**
 * POST /schedule/teacher — Giáo viên lưu khung giờ dạy/không dạy.
 * Body: class_id, slots[]. Không cho tắt slot đã có học sinh đăng ký.
 */
...
/** POST /schedule/slots/:slotId/book — Học sinh đăng ký khung giờ. */
...
/** DELETE /schedule/slots/:slotId/book — Học sinh hủy đăng ký khung giờ. */
